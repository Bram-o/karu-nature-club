                    ...
                    {submitted ? (
                        <div className="text-center py-12">
                            ...
                            <button
                                ...
                                className="mt-6 text-moss font-lato font-bold text-sm hover:text-forest transition-colors"
                            >
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    {paymentMethods.map((pm) => (
                                        <label
                                            key={pm.id}
                                            className={'flex items-center gap-3 border-2 rounded-xl p-4 cursor-pointer transition-all ' + (form.paymentMethod === pm.id ? 'border-moss bg-moss/5' : 'border-gray-200 hover:border-moss/30')}
                                        >
                                            <input
                                                type="radio"
                                                name="paymentMethod"
