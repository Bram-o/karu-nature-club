...
const subCommittees = [
  {
    id: 1,
    name: 'Tree Planting, Clean-up & Mentorship',
  ...
  {
    id: 2,
    name: 'Debates & First Aid',
    image: '/debates.jpeg',
    color: 'bg-green-50 border-green-200',
    accentColor: 'text-green-700',
    leader: 'Douglas Kirianki',
    role: 'Chairperson',
    avatar: 'DK',
    profilePic: '#',
  ...
  {
    id: 4,
    name: 'Art, Design & Catering',
    image: '/wildlife_&_birding.jpeg',
    color: 'bg-amber-50 border-amber-200',
    accentColor: 'text-amber-700',
    leader: 'Christine Mwangi',
    role: 'Chairperson',
    avatar: 'CM',
    profilePic: '#',
  ...
  {
    id: 5,
    name: 'Editorial Research & Innovation',
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16 animate-on-scroll">
          ...
          <p className="font-lato text-lg text-cream/70 max-w-2xl mx-auto">
            Six dedicated committees driving our mission — each led by passionate students committed to their focus area.
          </p>
        </div>
